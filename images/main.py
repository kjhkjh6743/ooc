...
cocktails = {
    ...
    'Negroni': {'ingredients': ['gin', 'vermouth rosso', 'campari'], 'taste': 'bitter', 'image': 'negroni.jpg'},
    'Pina Colada': {'ingredients': ['rum', 'coconut cream', 'pineapple'], 'taste': 'sweet', 'image': 'pina_colada.jpg'},
    'Bloody Mary': {'ingredients': ['vodka', 'tomato juice', 'spices'], 'taste': 'spicy', 'image': 'bloody_mary.jpg'},
    'Whiskey Sour': {'ingredients': ['whiskey', 'lemon juice', 'sugar'], 'taste': 'sour', 'image': 'whiskey_sour.jpg'},
    'Long Island Iced Tea': {'ingredients': ['vodka', 'rum', 'gin', 'tequila', 'triple sec', 'sour mix'], 'taste': 'strong', 'image': 'long_island_iced_tea.jpg'}
}
